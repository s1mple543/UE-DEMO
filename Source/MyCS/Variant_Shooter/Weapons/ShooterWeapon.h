 ...
 */
UCLASS()
class MYCS_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Separate timer for reloading (prevents timer conflicts with firing) */
...
public:
	...
	bool IsMagazineFull() const { return CurrentBullets >= MagazineSize; }
